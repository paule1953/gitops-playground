...
function printWelcomeScreen() {
  # TODO the dynamic length of hostnames destroys tbe box. We could resolve this using some bash math 
  # printf '%*s' $(( REQUIRED_SPACES - $(echo 'scmm' | wc -c) )) 
  echo
  echo
  echo "|-----------------------------------------------------------------------------------------------------------------------|"
  ...
  echo "| See here:                                                                                                             |"
  echo "|                                                                                                                       |"
  echo -e "| - \e[32mhttp://scm/repo/fluxv1/petclinic-plain/code/sources/main/\e[0m                                            |"
  echo -e "| - \e[32mhttp://$(hostname 'scmm')/scm/repo/fluxv2/petclinic-plain/code/sources/main/\e[0m                                            |"
  echo -e "| - \e[32mhttp://$(hostname 'scmm')/scm/repo/argocd/petclinic-plain/code/sources/main/\e[0m                                            |"
  echo "|                                                                                                                       |"
  ...
  echo "|                                                                                                                       |"
  echo -e "| - \e[32mhttp://$(hostname 'jenkins')/job/fluxv1-nginx/\e[0m                                                                             |"
  echo -e "| - \e[32mhttp://$(hostname 'jenkins')/job/fluxv1-petclinic-plain/\e[0m                                                                   |"
  echo -e "| - \e[32mhttp://$(hostname 'jenkins')/job/fluxv2-petclinic-plain/\e[0m                                                                   |"
  echo -e "| - \e[32mhttp://$(hostname 'jenkins')/job/argocd-petclinic-plain/\e[0m                                                                   |"
  echo "|                                                                                                                       |"
  echo "| During the job, jenkins pushes into the corresponding GitOps repo and creates a pull request for production:          |"
  echo "|                                                                                                                       |"
  echo "| For Flux V1:                                                                                                          |"
  echo "|                                                                                                                       |"
  echo -e "| - GitOps repo: \e[32mhttp://$(hostname 'scmm')/scm/repo/fluxv1/gitops/code/sources/main/\e[0m                                        |"
  echo -e "| - Pull requests: \e[32mhttp://$(hostname 'scmm')/scm/repo/fluxv1/gitops/pull-requests\e[0m                                           |"
  echo "|                                                                                                                       |"
  echo "| For Flux V2:                                                                                                          |"
  echo "|                                                                                                                       |"
  echo -e "| - GitOps repo: \e[32mhttp://$(hostname 'scmm')/scm/repo/fluxv2/gitops/code/sources/main/\e[0m                                        |"
  echo -e "| - Pull requests: \e[32mhttp://$(hostname 'scmm')/scm/repo/fluxv2/gitops/pull-requests\e[0m                                           |"
  echo "|                                                                                                                       |"
  echo "| For ArgoCD:                                                                                                           |"
  echo "|                                                                                                                       |"
  echo -e "| - GitOps repo: \e[32mhttp://$(hostname 'scmm')/scm/repo/argocd/gitops/code/sources/main/\e[0m                                        |"
  echo -e "| - Pull requests: \e[32mhttp://$(hostname 'scmm')/scm/repo/argocd/gitops/pull-requests\e[0m                                           |"
  echo "|                                                                                                                       |"
  echo -e "| There is also the ArgoCD UI which can be found at \e[32mhttp://$(hostname 'argo')/\e[0m                                              |"
  ...
  echo -e "| \e[32mhttp://$(hostname 'fluxv1-petclinic-plain-staging')/\e[0m for Flux V1 petclinic for staging                                                              |"
  echo -e "| \e[32mhttp://$(hostname 'fluxv1-petclinic-plain')/\e[0m for Flux V1 petclinic for production                                                           |"
  echo -e "| \e[32mhttp://$(hostname 'fluxv1-nginx-staging')/\e[0m for Flux V1 nginx for staging                                                                  |"
  echo -e "| \e[32mhttp://$(hostname 'fluxv1-nginx-staging')/\e[0m for Flux V1 nginx for production                                                               |"
  echo "|                                                                                                                       |"
  echo "| Flux V2 applications:                                                                                                 |"
  echo -e "| \e[32mhttp://$(hostname 'fluxv2-petclinic-plain-staging')/\e[0m for Flux V2 petclinic for staging                                                              |"
  echo -e "| \e[32mhttp://$(hostname 'luxv2-petclinic-plain')/\e[0m for Flux V2 petclinic for production                                                           |"
  echo "|                                                                                                                       |"
  echo "| ArgoCD applications:                                                                                                  |"
  echo -e "| \e[32mhttp://$(hostname 'argo-petclinic-plain')/\e[0m for ArgoCD petclinic for staging                                                               |"
  echo -e "| \e[32mhttp://$(hostname 'argo-petclinic')/\e[0m for ArgoCD petclinic for production                                                            |"
  echo "|                                                                                                                       |"
